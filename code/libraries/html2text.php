...
class html2text
{
    ...
    function _convert()
    {
        ...
        if ( !empty($this->_link_list) ) {
           // $text .= "\n\nLinks:\n------\n" . $this->_link_list; // AK: disabling this
        }
        ...
        //if ( $this->width > 0 ) {
            //$text = wordwrap($text, $this->width); // AK: disabling this to use bespoke ics_word_wrap() function instead.
        //}
    ...
    function _build_link_list( $link, $display )
    {
        if ( substr($link, 0, 7) == 'http://' || substr($link, 0, 8) == 'https://' ||
            ...
            $additional = '\n[' . $link . '] \n'; // AK: changed this to display the link instead on a new line
